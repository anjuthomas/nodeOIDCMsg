...
BasicIdToken.prototype.validateRequiredNonStandardVerificationClaims = function(claimsToVerify)
{
    ...
    /*Object.keys(BasicIdToken.prototype.non_standard_verification_claims).forEach(function (key) {
        if (!claimsToVerify[key]) {
            throw new Error('Missing required verification claim: ' + key);
        }else{
            BasicIdToken.prototype.non_standard_verification_claims[key] = claimsToVerify[key];            
        }
      });  */
};
