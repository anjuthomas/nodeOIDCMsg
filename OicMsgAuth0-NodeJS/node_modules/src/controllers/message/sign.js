...
messageSigner.sign = function (tokenProfile, secretOrPrivateKey, options, callback) {
  ...
  payload = this.checkOtherOptions(secretOrPrivateKey, options, tokenProfile, payload);
  payload = this.checkOptions(tokenProfile.options_to_payload, options, payload);
  payload = this.checkOptions(tokenProfile.knownNonStandardClaims, options, payload);
...
messageSigner.checkOtherOptions = function(secretOrPrivateKey, options, tokenProfile, payload){
...
messageSigner.checkOptions = function(tokenProfileKnownClaims, options, payload){
