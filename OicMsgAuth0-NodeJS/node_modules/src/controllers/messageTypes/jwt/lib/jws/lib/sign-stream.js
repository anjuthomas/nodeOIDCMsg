...
function jwsSecuredInputBase32(header, payload, encoding) {
  ...
  var encodedHeader = conv(toString(header), { in:'binary', out:'hex' });
  var encodedPayload = conv(toString(payload), { in:encoding, out:'hex' });
  return util.format('%s.%s', encodedHeader, encodedPayload);
}*/
...
function jwsSign(opts) {
  ...
  //var securedInput = jwsSecuredInputBase32(header, payload, encoding);
