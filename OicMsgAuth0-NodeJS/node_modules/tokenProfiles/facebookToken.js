...
FacebookToken.prototype.toJWT = function(secretOrPrivateKey, options){
    return jwt.sign(this, secretOrPrivateKey, options);
};

FacebookToken.prototype.fromJWT = function(signedJWT, secretOrPrivateKey, options){
    return jwt.decode(signedJWT,secretOrPrivateKey, this, options);
};

FacebookToken.prototype.toJSON = function(secretOrPrivateKey, options){
    // TODO
};

FacebookToken.prototype.fromJSON = function(signedJWT, secretOrPrivateKey, options){
    // TODO
};

FacebookToken.prototype.toUrlEncoded = function(secretOrPrivateKey, options){
    // TODO
};

FacebookToken.prototype.fromUrlEncoded = function(signedJWT, secretOrPrivateKey, options){
    // TODO
};
