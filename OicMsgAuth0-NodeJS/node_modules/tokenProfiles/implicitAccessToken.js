...
function ImplicitAccessToken(iss, sub, aud, iat){
    this.iss = iss;
    this.sub = sub;
    this.aud = aud;
    this.iat = iat;
...
ImplicitAccessToken.prototype = Object.create(AccessToken.prototype);
...
ImplicitAccessToken.prototype.validateRequiredFields = function(){
    if (this.iss && this.sub && this.aud && this.iat){
...
ImplicitAccessToken.prototype.getStandardClaims = function(){
    ImplicitAccessToken.prototype.standard_claims = { "iss" : this.iss, "sub" : this.sub, "aud" : this.aud, "iat": this.iat};
