...
Token Profiles folder contains the different types of token profile classes including the Basic ID Token class. Each token profile can be instantiated with its standard claims. 
